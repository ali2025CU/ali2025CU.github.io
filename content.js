  ...
  apps: [
    {
      ...
      links: [
        { label: "▶ Use the app", url: "flashcards-app.html" },
        { label: "⬇ Download", url: "flashcards.zip", download: true },
      ],
    },
    {
      ...
      meta: "Coming soon",
      description:
        "To add an app: add its HTML file next to the others, and a zip for download, then copy the links pattern from the Flashcards card above.",
